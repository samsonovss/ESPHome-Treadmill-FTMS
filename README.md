...
Возможности
  ...
  - Интелектуальное изминение скорости для пуьсометра
    - если разница больше 20, то скорость плавно изменяется на +-0.5 с шагом по 0.1 каждые 2е секунды.
    - если разница меньше 20, то скорость плавно изменяется на +-0.1. каждые 20 секунд
