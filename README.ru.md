...
## О проекте
Превратите старую беговую дорожку в умного помощника для тренировок! ESPHomeTreadmill — это бортовой компьютер на базе ESP32-S3 с прошивкой ESPHome. Он добавляет поддержку Zwift, Kinomap, FitShow и Kinni, а также интеллектуальные программы на основе пульса и управление через UART. Проект разработан для беговых дорожек с платами серии PSA(xx), но достаточно гибок, чтобы адаптироваться к любой дорожке с поддержкой UART. Минимум затрат — максимум возможностей!
...
### Тренировочные программы с пульсометром
...
- **Интервалы**: Чередование Зон 1 и 4 с автоматической настройкой скорости, с учетом пульса
