...
<details>
  <summary>Показать Hassio интерфейс беговой дорожки </summary>
  <p align="center">
...
- **Интерфейс**:
  <details>
  <summary><b>Дисплей Nextion</b>: Сенсорное управление. (▶️ Нажмите для деталей)</summary>
...
- **Поддержание пульса**: скорость меняется плавно в зависимости от разницы с целевой зоной:
  ...
  - Разница < 10 уд/мин: ±0.1 км/ч каждые 20 секунд. (настаривается время корекции в интерфейса hassio)
