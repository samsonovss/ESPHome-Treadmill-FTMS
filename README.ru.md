...
# Настройка UART для связи с беговой дорожкой 
# Используется для получения и отправки команд (например, [Setspeed:010], [Setincline:000])
uart:
...
# Укажите MAC-адрес вашего пульсометра
ble_client:
  - mac_address: "C9:5A:91:C1:92:58"  # Замените на MAC-адрес вашего пульсометра
